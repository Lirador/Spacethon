...
imageIzzy = cv2.imread("colorTest.jpg")

image = imageIzzy[0:320, 110:513]
#Cut image 
                ...
                if(isEgal(image[i,o],green) and isEgal(nextPix,green)==False and isEgal(nextPix,blue)==False ):
                        ...
                        if(o+decrementer<=width-1):
                            if (isEgal(image[i,o+decrementer],green) and checkIfThereAreColorInRangeOfPixel(blue,i,o)):
                                for u in range (0,decrementer):
                                    image[i,o+u] = green
                                exit = False
                            elif(isEgal(image[i,o+decrementer],blue) and checkIfThereAreColorInRangeOfPixel(green,i,o)):
                                for u in range (0,decrementer):
                                    image[i,o+u] = blue
                                exit = False
                        else:
                    ...
                    while exit:
                        ...
                        if(o+decrementer<=width-1):
                            ...
                            if (isEgal(image[i,o+decrementer],blue)):
                                for u in range (0,decrementer):
                                    image[i,o+u] = blue
                                exit = False
                            elif(isEgal(image[i,o+decrementer],green)):
